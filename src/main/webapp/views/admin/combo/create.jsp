...
<div class="py-2 px-3">
	...
	<form
		...
		novalidate method="post" action="${url}admin/createcombo">
			...
			<div class="col-6">
				<div>
					<label class="form-label text-sm text-dark fw-bolder">Mã
						...
						class="form-control form-control-sm" name="giaCombo" required
						min="50000" max="10000000" placeholder="Nhập giá combo - đồ ăn" />
		...
		<div class="d-block text-end">
			...
			<button type="submit" class="btn btn-sm bg-first text-white">Thêm
				mới</button>
		</div>
	</form>
