...
<div class="py-2 px-3">
	...
	<form class="rounded-3 overflow-hidden shadow-sm bg-white px-4 py-3" method="post">
		...
		<h5 class="mb-4">Cập nhật thanh phố</h5>
		<!-- <div>
                  <button
		...
		<div class="row g-3 mb-3">
			<div class="col-6">
				<div>
				<input name="maThanhPho" hidden value="${thanhpho.maThanhPho}">
					<label class="form-label text-sm text-dark fw-bolder mb-1">Tên
						...
						name="tenThanhPho" value="${thanhpho.tenThanhPho}"
		...
		<div class="d-block text-end">
			...
			<button formaction="updatethanhpho" class="btn btn-sm bg-first text-white">Cập nhật</button>
		</div>
	</form>
