	...
	<div class="rounded-3 overflow-hidden shadow-sm bg-white px-4 py-3">
		<div class="d-flex justify-content-between">
			...
			<div>
				...
				</a> <a href="${url}admin/createquocgia"
					...
					<tr class="text-sm">
						...
						<td>
							<div class="d-flex column-gap-2">
								<a
									href="${url}admin/deletequocgia?maQuocGia=${quocGia.maQuocGia}"
									class="ri-delete-bin-6-line text-dark text-decoration-none"
									style="cursor: pointer" title="Xóa"></a><a
									href="${url}admin/updatequocgia?maQuocGia=${quocGia.maQuocGia}"
