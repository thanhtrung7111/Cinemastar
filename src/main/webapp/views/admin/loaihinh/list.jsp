	...
	<div class="rounded-3 overflow-hidden shadow-sm bg-white px-4 py-3">
		<div class="d-flex justify-content-between">
			...
			<div>
				...
				</a> <a href="${url}admin/createloaihinh"
		...
		<table class="table">
			<thead>
				<tr>
					...
					<th scope="col">#</th>
					<th scope="col">Mã loại hình</th>
					<th scope="col">Tên loại hình</th>
					<th scope="col"></th>
				</tr>
			</thead>
			<tbody>
				<c:forEach var="loaiHinh" items="${loaiHinhs}" varStatus="loop">
					<tr class="text-sm">
						<td><input type="checkbox" /></td>
						<td>${loop.index +1}</td>
						<td>${loaiHinh.maLoaiHinh}</td>
						<td>${loaiHinh.tenLoaiHinh}</td>


						<td>
							<div class="d-flex column-gap-2">
								<a
									href="${url}admin/deleteloaihinh?maLoaiHinh=${loaiHinh.maLoaiHinh}"
									class="ri-delete-bin-6-line text-dark text-decoration-none"
									style="cursor: pointer" title="Xóa"></a><a
									href="${url}admin/updateloaihinh?maLoaiHinh=${loaiHinh.maLoaiHinh}"
