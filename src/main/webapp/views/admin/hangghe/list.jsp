	...
	<div class="rounded-3 overflow-hidden shadow-sm bg-white px-4 py-3">
		<div class="d-flex justify-content-between">
			...
			<div>
				...
				</a> <a href="${url}admin/createhangghe"
		...
		<table class="table">
			...
			<tbody>
				<c:forEach var="hangGhe" items="${hangGhes}" varStatus="loop">
					<tr class="text-sm">
						<td><input type="checkbox" /></td>
						<td>${loop.index +1}</td>
						<td>${hangGhe.maHangGhe}</td>
						<td>${hangGhe.tenHangGhe}</td>


						<td>
							<div class="d-flex column-gap-2">
								<a
									href="${url}admin/deletehangghe?maHangGhe=${hangGhe.maHangGhe}"
									class="ri-delete-bin-6-line text-dark text-decoration-none"
									style="cursor: pointer" title="Xóa"></a><a
									href="${url}admin/updatehangghe?maHangGhe=${hangGhe.maHangGhe}"
